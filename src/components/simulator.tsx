...
export default function Simulator() {
    ...
    const [phoneANumber, setPhoneANumber] = useState<string>(getRandomPhoneNumber());
    const [phoneBNumber, setPhoneBNumber] = useState<string>(getRandomPhoneNumber());
    ...
    return (
        <section className="bg-gray-100 py-20">    
            ...
            <div className="flex flex-row w-full justify-center items-center pb-12">
                <h1 className="h2 pr-5">Ripple Mobile USSD Simulator</h1>
            ...
            <div className="px-10 grid grid-cols-2 gap-5">
                ...
                <div className="flex flex-col bg-zinc-300 p-10 rounded-lg">
                    <div className="flex flex-row w-full justify-between items-center">
                        <div>
                            <h1 className="h2">Phone A Simulator</h1>
                            <h4 className="h4">
                                <span>Session Phone Number: </span>  
                                <span className="text-zinc-600">+{phoneANumber}</span>    
                            </h4> 
                        </div>
                        <button onClick={() => alert('mine')} className="flex justify-center items-center w-10 h-10 bg-zinc-400 rounded-md">
                ...
                <div className="flex flex-col bg-zinc-300 p-10 rounded-lg">
                    <div className="flex flex-row w-full justify-between items-center">
                        <div>
                            <h1 className="h2">Phone B Simulator</h1>
                            <h4 className="h4">
                                <span>Session Phone Number: </span>  
                                <span className="text-zinc-600">+{phoneBNumber}</span>    
                            </h4> 
                        </div>
                        <button onClick={() => alert(getRandomPhoneNumber())} className="flex justify-center items-center w-10 h-10 bg-zinc-400 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 stroke-2" viewBox="0 0 24 24">
                                <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0112.548-3.364l1.903 1.903h-3.183a.75.75 0 100 1.5h4.992a.75.75 0 00.75-.75V4.356a.75.75 0 00-1.5 0v3.18l-1.9-1.9A9 9 0 003.306 9.67a.75.75 0 101.45.388zm15.408 3.352a.75.75 0 00-.919.53 7.5 7.5 0 01-12.548 3.364l-1.902-1.903h3.183a.75.75 0 000-1.5H2.984a.75.75 0 00-.75.75v4.992a.75.75 0 001.5 0v-3.18l1.9 1.9a9 9 0 0015.059-4.035.75.75 0 00-.53-.918z" clipRule="evenodd" />
                            </svg>
                        </button>
